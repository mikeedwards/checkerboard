...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Extent'
        db.create_table('spotter_extent', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django_extensions.db.fields.CreationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('lon_ne', self.gf('django.db.models.fields.FloatField')()),
            ('modified', self.gf('django_extensions.db.fields.ModificationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('lat_ne', self.gf('django.db.models.fields.FloatField')()),
            ('geodetic_system', self.gf('django.db.models.fields.CharField')(default='WGS 84', max_length=50)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('lat_sw', self.gf('django.db.models.fields.FloatField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lon_sw', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('spotter', ['Extent'])

        # Adding model 'BooleanQuestion'
        db.create_table('spotter_booleanquestion', (
            ('question_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['spotter.Question'], unique=True, primary_key=True)),
            ('false_text', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=30)),
            ('true_text', self.gf('django.db.models.fields.CharField')(default='true', max_length=30)),
        ))
        db.send_create_signal('spotter', ['BooleanQuestion'])

        # Adding model 'Habitat'
        db.create_table('spotter_habitat', (
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created', self.gf('django_extensions.db.fields.CreationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('altitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored_habitats', to=orm['community.Mentor'])),
            ('lon', self.gf('django.db.models.fields.FloatField')()),
            ('modified', self.gf('django_extensions.db.fields.ModificationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('altitude_accuracy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('geodetic_system', self.gf('django.db.models.fields.CharField')(default='WGS 84', max_length=50)),
            ('extent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='habitats', to=orm['spotter.Extent'])),
            ('lat', self.gf('django.db.models.fields.FloatField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('accuracy', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('spotter', ['Habitat'])

        # Adding model 'BooleanAnswer'
        db.create_table('spotter_booleananswer', (
        ...
        db.send_create_signal('spotter', ['BooleanAnswer'])

        # Deleting field 'Question.spotting'
        db.delete_column('spotter_question', 'spotting_id')

        # Adding field 'Question.habitat'
        db.add_column('spotter_question', 'habitat', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questions', to=orm['spotter.Habitat']), keep_default=False)

        # Adding field 'Spotting.habitat'
        db.add_column('spotter_spotting', 'habitat', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='spottings', to=orm['spotter.Habitat']), keep_default=False)

        # Adding field 'Spotting.author'
        db.add_column('spotter_spotting', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='spottings', to=orm['community.Learner']), keep_default=False)

        # Adding field 'Spotting.geodetic_system'
        db.add_column('spotter_spotting', 'geodetic_system', self.gf('django.db.models.fields.CharField')(default='WGS 84', max_length=50), keep_default=False)

        # Deleting field 'Answer.learner'
        db.delete_column('spotter_answer', 'learner_id')

        # Adding field 'Answer.spotting'
        db.add_column('spotter_answer', 'spotting', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='answers', to=orm['spotter.Spotting']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting model 'Extent'
        db.delete_table('spotter_extent')

        # Deleting model 'BooleanQuestion'
        db.delete_table('spotter_booleanquestion')

        # Deleting model 'Habitat'
        db.delete_table('spotter_habitat')

        # Deleting model 'BooleanAnswer'
        db.delete_table('spotter_booleananswer')

        # Adding field 'Question.spotting'
        db.add_column('spotter_question', 'spotting', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questions', to=orm['spotter.Spotting']), keep_default=False)

        # Deleting field 'Question.habitat'
        db.delete_column('spotter_question', 'habitat_id')

        # Deleting field 'Spotting.habitat'
        db.delete_column('spotter_spotting', 'habitat_id')

        # Deleting field 'Spotting.author'
        db.delete_column('spotter_spotting', 'author_id')

        # Deleting field 'Spotting.geodetic_system'
        db.delete_column('spotter_spotting', 'geodetic_system')

        # Adding field 'Answer.learner'
        db.add_column('spotter_answer', 'learner', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='answers', to=orm['community.Learner']), keep_default=False)

        # Deleting field 'Answer.spotting'
        db.delete_column('spotter_answer', 'spotting_id')
    ...
    models = {
        ...
        'spotter.booleanquestion': {
            ...
            'false_text': ('django.db.models.fields.IntegerField', [], {'default': "'false'", 'max_length': '30'}),
        ...
        'spotter.habitat': {
            ...
            'geodetic_system': ('django.db.models.fields.CharField', [], {'default': "'WGS 84'", 'max_length': '50'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigators': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'habitats_investigated'", 'symmetrical': 'False', 'through': "orm['spotter.Spotting']", 'to': "orm['community.Learner']"}),
