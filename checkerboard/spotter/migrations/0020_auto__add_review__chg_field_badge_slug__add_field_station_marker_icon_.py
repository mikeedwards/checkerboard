...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Review'
        db.create_table('spotter_review', (
            ('created', self.gf('django_extensions.db.fields.CreationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('accomplishment', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', to=orm['spotter.Accomplishment'])),
            ('modified', self.gf('django_extensions.db.fields.ModificationDateTimeField')(default=datetime.datetime.now, blank=True)),
            ('reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reviews', to=orm['auth.User'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('spotter', ['Review'])

        # Adding field 'Station.marker_icon'
        db.add_column('spotter_station', 'marker_icon', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Accomplishment.reviewed_on'
        db.delete_column('spotter_accomplishment', 'reviewed_on')

        # Deleting field 'Accomplishment.reviewer'
        db.delete_column('spotter_accomplishment', 'reviewer_id')
    
    
    def backwards(self, orm):
        
        # Deleting model 'Review'
        db.delete_table('spotter_review')

        # Deleting field 'Station.marker_icon'
        db.delete_column('spotter_station', 'marker_icon')

        # Adding field 'Accomplishment.reviewed_on'
        db.add_column('spotter_accomplishment', 'reviewed_on', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Accomplishment.reviewer'
        db.add_column('spotter_accomplishment', 'reviewer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='accomplishments_reviewed', null='True', to=orm['auth.User']), keep_default=False)
    ...
    models = {
        ...
        'spotter.question': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'ending': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 12, 13, 56, 36, 162912)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inquiry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['spotter.Inquiry']"}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 15, 13, 56, 36, 162697)'}),
