...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Spotting.lon'
        db.delete_column('spotter_spotting', 'lon')

        # Deleting field 'Spotting.lat'
        db.delete_column('spotter_spotting', 'lat')

        # Deleting field 'Spotting.altitude'
        db.delete_column('spotter_spotting', 'altitude')

        # Deleting field 'Habitat.altitude'
        db.delete_column('spotter_habitat', 'altitude')

        # Deleting field 'Habitat.lon'
        db.delete_column('spotter_habitat', 'lon')

        # Deleting field 'Habitat.lat'
        db.delete_column('spotter_habitat', 'lat')
    
    
    def backwards(self, orm):
        
        # Adding field 'Spotting.lon'
        db.add_column('spotter_spotting', 'lon', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Spotting.lat'
        db.add_column('spotter_spotting', 'lat', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Spotting.altitude'
        db.add_column('spotter_spotting', 'altitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Habitat.altitude'
        db.add_column('spotter_habitat', 'altitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Habitat.lon'
        db.add_column('spotter_habitat', 'lon', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Habitat.lat'
        db.add_column('spotter_habitat', 'lat', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
