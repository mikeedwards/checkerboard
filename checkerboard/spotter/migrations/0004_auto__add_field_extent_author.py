...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Extent.author'
        db.add_column('spotter_extent', 'author', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='authored_extents', to=orm['community.Mentor']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Extent.author'
        db.delete_column('spotter_extent', 'author_id')
