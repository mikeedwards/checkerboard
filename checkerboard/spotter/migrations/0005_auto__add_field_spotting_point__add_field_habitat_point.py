...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Spotting.point'
        db.add_column('spotter_spotting', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(default=None), keep_default=False)

        # Adding field 'Habitat.point'
        db.add_column('spotter_habitat', 'point', self.gf('django.contrib.gis.db.models.fields.PointField')(default=None), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Spotting.point'
        db.delete_column('spotter_spotting', 'point')

        # Deleting field 'Habitat.point'
        db.delete_column('spotter_habitat', 'point')
