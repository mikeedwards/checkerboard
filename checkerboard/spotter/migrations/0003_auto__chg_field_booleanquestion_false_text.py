...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BooleanQuestion.false_text'
        db.alter_column('spotter_booleanquestion', 'false_text', self.gf('django.db.models.fields.CharField')(max_length=30))
    
    
    def backwards(self, orm):
        
        # Changing field 'BooleanQuestion.false_text'
        db.alter_column('spotter_booleanquestion', 'false_text', self.gf('django.db.models.fields.IntegerField')(max_length=30))
