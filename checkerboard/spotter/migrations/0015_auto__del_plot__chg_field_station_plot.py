...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Plot'
        db.delete_table('spotter_plot')

        # Changing field 'Station.plot'
        db.alter_column('spotter_station', 'plot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Plot']))
    
    
    def backwards(self, orm):
        
        # Adding model 'Plot'
        db.create_table('spotter_plot', (
            ('polygon', self.gf('django.contrib.gis.db.models.fields.PolygonField')()),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='authored_plots', to=orm['auth.User'])),
        ...
        db.send_create_signal('spotter', ['Plot'])

        # Changing field 'Station.plot'
        db.alter_column('spotter_station', 'plot_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotter.Plot']))
    ...
    models = {
        ...
        'spotter.station': {
            ...
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'plot': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'stations'", 'to': "orm['community.Plot']"}),
            'point': ('django.contrib.gis.db.models.fields.PointField', [], {}),
