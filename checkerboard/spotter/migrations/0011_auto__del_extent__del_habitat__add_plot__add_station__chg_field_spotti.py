...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_table('spotter_extent', 'spotter_plot') 
        db.rename_table('spotter_habitat', 'spotter_station') 
        # Changing field 'Spotting.habitat'
        db.alter_column('spotter_spotting', 'habitat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotter.Station']))

        # Changing field 'Question.habitat'
        db.alter_column('spotter_question', 'habitat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotter.Station']))
    
    
    def backwards(self, orm):
        
        db.rename_table('spotter_plot','spotter_extent') 
        db.rename_table('spotter_station', 'spotter_habitat') 

        # Changing field 'Spotting.habitat'
        db.alter_column('spotter_spotting', 'habitat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotter.Habitat']))

        # Changing field 'Question.habitat'
        db.alter_column('spotter_question', 'habitat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['spotter.Habitat']))
    ...
    models = {
        ...
        'spotter.question': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'habitat': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['spotter.Station']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'spotter.spotting': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'habitat': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'spottings'", 'to': "orm['spotter.Station']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'spotter.station': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'extent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'habitats'", 'to': "orm['spotter.Plot']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
