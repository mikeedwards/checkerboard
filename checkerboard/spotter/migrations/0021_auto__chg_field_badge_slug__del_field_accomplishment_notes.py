...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Accomplishment.notes'
        db.delete_column('spotter_accomplishment', 'notes')
    
    
    def backwards(self, orm):
        
        # Adding field 'Accomplishment.notes'
        db.add_column('spotter_accomplishment', 'notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'spotter.question': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'ending': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 12, 14, 55, 5, 966763)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inquiry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['spotter.Inquiry']"}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 15, 14, 55, 5, 966540)'}),
