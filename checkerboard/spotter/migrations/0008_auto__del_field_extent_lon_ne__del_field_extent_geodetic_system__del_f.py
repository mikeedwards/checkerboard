...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Extent.lon_ne'
        db.delete_column('spotter_extent', 'lon_ne')

        # Deleting field 'Extent.geodetic_system'
        db.delete_column('spotter_extent', 'geodetic_system')

        # Deleting field 'Extent.lat_sw'
        db.delete_column('spotter_extent', 'lat_sw')

        # Deleting field 'Extent.lat_ne'
        db.delete_column('spotter_extent', 'lat_ne')

        # Deleting field 'Extent.lon_sw'
        db.delete_column('spotter_extent', 'lon_sw')
    
    
    def backwards(self, orm):
        
        # Adding field 'Extent.lon_ne'
        db.add_column('spotter_extent', 'lon_ne', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Extent.geodetic_system'
        db.add_column('spotter_extent', 'geodetic_system', self.gf('django.db.models.fields.CharField')(default='WGS 84', max_length=50), keep_default=False)

        # Adding field 'Extent.lat_sw'
        db.add_column('spotter_extent', 'lat_sw', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Extent.lat_ne'
        db.add_column('spotter_extent', 'lat_ne', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'Extent.lon_sw'
        db.add_column('spotter_extent', 'lon_sw', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)
