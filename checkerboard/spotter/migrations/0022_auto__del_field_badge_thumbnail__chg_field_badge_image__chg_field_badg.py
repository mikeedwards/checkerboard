...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Badge.thumbnail'
        db.delete_column('spotter_badge', 'thumbnail')

        # Changing field 'Badge.image'
        db.alter_column('spotter_badge', 'image', self.gf('stdimage.fields.StdImageField')(blank=True, max_length=100, thumbnail_size={'width': 48, 'force': None, 'height': 48}, size={'width': 120, 'force': None, 'height': 120}))
    
    
    def backwards(self, orm):
        
        # Adding field 'Badge.thumbnail'
        db.add_column('spotter_badge', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(default='missing.jpg', max_length=100), keep_default=False)

        # Changing field 'Badge.image'
        db.alter_column('spotter_badge', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'spotter.question': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'ending': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 16, 11, 24, 21, 441449)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inquiry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['spotter.Inquiry']"}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 19, 11, 24, 21, 441414)'}),
