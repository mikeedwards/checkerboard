...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Habitat.time_limit'
        db.add_column('spotter_habitat', 'time_limit', self.gf('django.db.models.fields.IntegerField')(default=300), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Habitat.time_limit'
        db.delete_column('spotter_habitat', 'time_limit')
