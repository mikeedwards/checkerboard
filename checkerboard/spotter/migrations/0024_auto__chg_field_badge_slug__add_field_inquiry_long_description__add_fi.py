...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Inquiry.long_description'
        db.add_column('spotter_inquiry', 'long_description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Inquiry.payoff'
        db.add_column('spotter_inquiry', 'payoff', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Inquiry.instructions'
        db.add_column('spotter_inquiry', 'instructions', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Inquiry.long_description'
        db.delete_column('spotter_inquiry', 'long_description')

        # Deleting field 'Inquiry.payoff'
        db.delete_column('spotter_inquiry', 'payoff')

        # Deleting field 'Inquiry.instructions'
        db.delete_column('spotter_inquiry', 'instructions')
    ...
    models = {
        ...
        'spotter.inquiry': {
            ...
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'payoff': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'spotter.question': {
            ...
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'ending': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 8, 17, 14, 42, 18, 245998)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inquiry': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'questions'", 'to': "orm['spotter.Inquiry']"}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '10'}),
            'starting': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 7, 20, 14, 42, 18, 245963)'}),
