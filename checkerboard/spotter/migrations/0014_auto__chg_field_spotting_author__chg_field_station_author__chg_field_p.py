...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Spotting.author'
        db.alter_column('spotter_spotting', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Station.author'
        db.alter_column('spotter_station', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Plot.author'
        db.alter_column('spotter_plot', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Snapshot.author'
        db.alter_column('spotter_snapshot', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Deleting field 'Question.mentor'
        db.delete_column('spotter_question', 'mentor_id')

        # Adding field 'Question.user'
        db.add_column('spotter_question', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questions', to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Changing field 'Spotting.author'
        db.alter_column('spotter_spotting', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Learner']))

        # Changing field 'Station.author'
        db.alter_column('spotter_station', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Mentor']))

        # Changing field 'Plot.author'
        db.alter_column('spotter_plot', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Mentor']))

        # Changing field 'Snapshot.author'
        db.alter_column('spotter_snapshot', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['community.Mentor']))

        # Adding field 'Question.mentor'
        db.add_column('spotter_question', 'mentor', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='questions', to=orm['community.Mentor']), keep_default=False)

        # Deleting field 'Question.user'
        db.delete_column('spotter_question', 'user_id')
    ...
    models = {
        ...
        'spotter.snapshot': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'snapshots'", 'to': "orm['auth.User']"}),
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'spotter.spotting': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'spottings'", 'to': "orm['auth.User']"}),
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'spotter.station': {
            ...
            'altitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'altitude_accuracy': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'authored_stations'", 'to': "orm['auth.User']"}),
            'created': ('django_extensions.db.fields.CreationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'investigators': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'investigated_stations'", 'symmetrical': 'False', 'through': "orm['spotter.Spotting']", 'to': "orm['auth.User']"}),
            'modified': ('django_extensions.db.fields.ModificationDateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
