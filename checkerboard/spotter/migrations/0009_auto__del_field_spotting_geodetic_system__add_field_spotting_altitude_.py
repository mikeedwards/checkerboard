...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Habitat.geodetic_system'
        db.delete_column('spotter_habitat', 'geodetic_system')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Habitat.geodetic_system'
        db.add_column('spotter_habitat', 'geodetic_system', self.gf('django.db.models.fields.CharField')(default='WGS 84', max_length=50), keep_default=False)
