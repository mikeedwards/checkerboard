...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('spotter_station', 'extent_id', 'plot_id')
        db.rename_column('spotter_spotting', 'habitat_id', 'station_id')
        db.rename_column('spotter_question', 'habitat_id', 'station_id')    
    
    def backwards(self, orm):
        
        db.rename_column('spotter_station', 'plot_id', 'extent_id')
        db.rename_column('spotter_spotting', 'station_id', 'habitat_id')
        db.rename_column('spotter_question', 'station_id', 'habitat_id')    
